...
|---|---|---|---|---|---|---|
|BF2556X_1T<br>BF6064X_T|v1.4.2 (or latest from repo)|sal_1.2.0|bf-reference-bsp-9.4.0-BF2556_1.0.1.zip<br>bf-reference-bsp-9.4.0-BF6064_1.0.1.zip|BF_SDE_9.4.0|Ubuntu Server 18.04.4 LTS|5.4.x
